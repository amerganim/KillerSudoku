 ...
 */
/** The part of the wallet the game screen needs. An interface so the game can be tested without a Context. */
interface HintBank {
    /** Takes one hint; false when the wallet is empty. */
    suspend fun spendHint(): Boolean

    /** Adds the one hint a rewarded video earns. */
...
class MonetizationRepository(
     ...
     */
    override suspend fun spendHint(): Boolean {
    ...
    override suspend fun grantHintFromAd() {
